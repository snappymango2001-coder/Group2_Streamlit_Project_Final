...
def add_custom_css():
    css = """
    <style>
    /* Main app background to lilac */
    .stApp {
        background-color: #D8BFD8 !important;  /* pastel lilac */
        color: #333333 !important;             /* dark text for contrast */
    }

    /* Sidebar background to light blue */
    .css-1d391kg, .css-1v3fvcr {
        background-color: #A3C4F3 !important;  /* pastel blue */
    ...
    /* Optional: adjust filter widget backgrounds for better contrast */
    .stSidebar div[data-baseweb="select"] > div {
        background-color: #C6D8F9 !important;  /* lighter blue for selects */
    }
    </style>
    """
